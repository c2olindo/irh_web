...
div#resource-attachment-upload
{
  position: relative;
  overflow:hidden;
}
div#resource-attachment-upload:before
{
    content: "";
    opacity: .1;
...
div#resource-attachment-upload:after 
{
    content: "";
    opacity: .1;
    background-color: #6376ec;
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <div class="dropzone needsclick dz-clickable p-5" id="resource-attachment-upload">
                  <div class="dz-message needsclick" id="fileDropInput">
                    <h6 class="text-center lead">
                    <img class="center-block" src="{{ asset('irh_assets/images/cloud.svg') }}" alt="Drag &amp; drop files here">
                    <br>
                    Drag &amp; drop files here or <br>
                    <button type="button" class="btn btn-outline-primary mt-3">Browse your computer</a>
                    </h6>
                  </div>
                </div>
              ...
              <div class="form-group">
                <label for="cover-image">Cover Image <small class="text-muted">( This is the image that will be displayed in search results )</small></label>
                <input type="file" class="form-control slide_1_group" name="cover_image">
              </div>
              <div class="form-group">
                <label for="preview-image">Preview Image (optional) <small class="text-muted">( This is the image that will be displayed when a person is viewing your resource )</small></label>
              ...
              <div class="form-group">
                ...
                <textarea name="desc" id="resource_description" rows="3" class="form-control slide_1_group"></textarea>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row mt-4">
              <div class="col-md-4">
                <div class="card text-center" style="height: 262px;">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Attribution Licence</h6>
                  </div>
                  <div class="card-body">
                    <p>
              ...
              <div class="col-md-4">
                <div class="card text-center" style="height: 262px;">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">ShareAlike Licence</h6>
                  </div>
                  <div class="card-body ">
                    <p>
              ...
              <div class="col-md-4">
                <div class="card text-center" style="height: 262px;">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">NoDerivatives Licence</h6>
                  </div>
                  <div class="card-body">
                    <p>
          ...
          <div class="container">
            <div class="row mb-3">
              <div class="col-md-6 offset-md-3">
                <input type="checkbox" name="tac" id="termsConditionsCheck" required> I agree to the <a href="{{ url('/terms-and-conditions') }}" target="_blank">Terms and Conditions</a> and <a href="{{ url('/privacy-policy') }}" target="_blank">Privacy Policy</a>.
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
               <button type="submit" name="resource_upload" value="publish" class="btn btn-success btn-block">Submit for Review</button>
              </div>
            </div>
          </div>
        </div>
