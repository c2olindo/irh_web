          ...
          <div class="nav-wrapper">
            ...
            <ul class="nav flex-column">
             ...
             <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link {{ (\Request::route()->getName() == 'dashboard.testimonials.index') ? 'active' : '' }}" href="{{ route('dashboard.testimonials.index') }}">
              ...
              <li class="nav-item">
                <a class="nav-link {{ (\Request::route()->getName() == 'dashboard.settings') ? 'active' : '' }}" href="{{ route('dashboard.settings') }}">
                  <i class="material-icons">list</i>
                  <span>Settings</span>
                </a>
              </li>
