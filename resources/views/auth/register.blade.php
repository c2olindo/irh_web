                            ...
                            <div class="row">
                                <div class="col-md-8 offset-md-2">
                                    ...
                                    <form action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" value="accept" name="terms" required> <p class="ml-1 d-inline" style="font-size: 13px;">I agree to <a href="{{ url('/terms-and-conditions') }}" target="_blank" style="color:#26a0d6;">Terms &amp; Conditions</a></p>
                                        </div>
                                        <div class="form-group">
