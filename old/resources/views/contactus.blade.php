@extends('layouts.app')
@section('content')
<header  style="background:url({{ asset('irh_assets/images/contactbg.jpg') }});height: 820px;background-size: cover;background-position:center; ">
</header>
		...
		<div class="row">
			...
			<div class="col-md-4 px-0">
				<div class="card p-5 bg-blue text-white text-left" style="height: 520px;">
					<h3 class="mb-0 pb-4">Contact Information</h3>
					{{-- <div class="d-flex flex-column py-3">
						<div class="d-flex flex-row">
							...
							<div class="flex-column px-2">
								360 Amrood Street
								Anjaord Road Shasganrd Market Chamtokhan
							</div>
						</div>
					</div>
					<div class="d-flex flex-column py-3">
					...
					<div class="d-flex flex-column py-3">
						<div class="d-flex flex-row">
							...
							<div class="flex-column px-2">
								info@islamicresourcehub.com
							</div>
						</div>
					</div> --}}
					<div class="card card-body" style="box-shadow: 0px 5px 6px 1px #3333338f;">
