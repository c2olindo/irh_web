...
@stop
@section('content')
<header id="main-header" style="background:linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url({{ asset('irh_assets/images/slider1.jpg') }});height: 800px;background-size: cover;background-attachment: fixed;">
	<div class="header-content">
		<h1 class="signika">Resources made by you. Free. <strong>Forever.</strong></h1>
		<form action="{{ route('theme.resources.filtered') }}" method="GET" id="search-form">
			<div class="input-group">
				...
				<div class="input-group-prepend">
		          <span class="input-group-text" id="inputGroupPrepend" onclick="event.preventDefault();
				...
				<div class="resourcebox">
					<div class="card">
					  ...
					  <span style="position: absolute;top: -1;right: 10px;">
					  	...
					  	<a href="{{ route('theme.saveresource',$fr) }}">
					  ...
					  <div class="card-body">
					  	<div class="pb-4"><img src="{{ asset('irh_assets/images/avatar.png') }}" alt="" width="30px" class="rounded-circle" style="display: inline-block;"><span class="ml-3">{{ $fr->user->full_name }}</span></div>
...
<section id="new_resources" class="text-center py-5">
	<div class="container">
				...
				<div class="resourcebox">
					<div class="card">
					  ...
					  <span style="position: absolute;top: -1;right: 10px;">
					  	...
					  	<a href="{{ route('theme.saveresource',$nr) }}">
					  	<img src="{{ asset('irh_assets/images/savelogo.png') }}" alt="" width="25px" data-toggle="tooltip" data-placement="top" title="save for later">
					  	</a>
					  	@else
					  	<img src="{{ asset('irh_assets/images/savedlogo.png') }}" alt="" width="25px">
					  ...
					  <div class="card-body">
					  	<div class="pb-4"><img src="{{ asset('irh_assets/images/avatar.png') }}" alt="" width="30px" class="rounded-circle" style="display: inline-block;"><span class="ml-3">{{ $nr->user->full_name }}</span></div>
		...
		<div class="row pt-5">
			<div class="col-md-4 offset-md-4">
				<a href="{{ route('theme.resources') }}" class="btn btn-lg bg-blue" style="border-radius: 2em;">Discover more Resources</a>
			</div>
		</div>
	</div>
</section>
<section id="testimonials" class="text-center py-5 bg-blue" style="border: none !important;">
	<div class="container">
		<h1 class="pb-2 signika">Testimonials</h1>
			...
			<div class="item">
				<div class="card card-body" style="min-height: 300px;">
					<div class="py-5 blue-color">
						<p>
							Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium est, harum excepturi placeat voluptates vitae recusandae neque dignissimos obcaecati asperiores ducimus, maxime sapiente aspernatur distinctio quidem, soluta explicabo! Repellendus, voluptates!
						</p>
					</div>
					<div class="py-2">
						<img src="{{ asset('irh_assets/images/avatar.png') }}" alt="" width="30px" class="rounded-circle" style="display: inline-block;"><span class="ml-3 blue-color">John Doe</span>
					</div>
				</div>
			</div>
